...
// src/index.ts
var keyvMysqlKeys = /* @__PURE__ */ new Set(["adapter", "compression", "connect", "dialect", "keySize", "table", "ttl", "uri"]);
var KeyvMysql = class extends import_events.default {
  ttlSupport;
  opts;
  namespace;
  query;
  ...
  async clear() {
    ...
    const del = import_mysql22.default.format(sql, [this.namespace ? `${this.namespace}:%` : "%"]);
    await this.query(del);
  }
  async *iterator(namespace) {
    ...
    async function* iterate(offset, options, query) {
      ...
      const select = import_mysql22.default.format(sql, [`${namespace ? namespace + ":" : ""}%`, limit, offset]);
